...
(function () {
  ...
  async function init() {
    ...
    if (!ok) { const h = document.createElement("div"); h.className = "reader-off"; h.innerHTML = 'โหมดอ่านอย่างเดียว — รัน <code>npm run read</code> เพื่อคอมเมนต์'; document.body.appendChild(h); setTimeout(() => h.remove(), 6000); return; }
